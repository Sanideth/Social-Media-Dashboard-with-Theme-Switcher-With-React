...
function GridSecondary() {
    return (
        <div className="main__grid-secondary">
            ...
            <BoxGridSecondary text="Likes" logo={facebookLogo} numbers="52" icon={iconDown}  change="2" colorClass="red"/>
            ...
            <BoxGridSecondary text="Likes" logo={youtubeLogo}numbers="107" icon={iconDown}  change="19" colorClass="red"/>
            <BoxGridSecondary text="Total Views" logo={youtubeLogo}numbers="1407" icon={iconDown}  change="12" colorClass="red"/>
        </div>
    )
}
